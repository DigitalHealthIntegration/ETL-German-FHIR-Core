...
questionnaire_response_id = app_prov_details.questionnaire_response_logical_id
	from (
		with qr_details as (
		...
		select vo.visit_occurrence_id , vo.person_id, vo.care_site_id, appointment_logical_id, questionnaire_response_logical_id  from qr_details qd, provenance_details pd, cds_cdm.visit_occurrence vo, cds_cdm.appointment app
